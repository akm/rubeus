...
puts "Rubeus::VERSION => #{Rubeus::VERSION}"
...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("activesupport", "= 2.1.2")
  spec.files = FileList['Rakefile', 'rmaven.yml', 'bin/*', '{lib,examples,test}/**/*.{rb,jar,rtf,png,xml}'].to_a
